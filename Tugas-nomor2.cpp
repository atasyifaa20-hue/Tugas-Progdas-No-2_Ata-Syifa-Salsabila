...
//Fungsi untuk memanggil distance
...
int main() {
    double x1, y1, x2, y2;
    cout << "Masukkan x pusat: "; cin >> x1;
    cout << "Masukkan y pusat: "; cin >> y1;
    cout << "Masukkan x titik lingkaran: "; cin >> x2;
    cout << "Masukkan y titik lingkaran: "; cin >> y2;
